...
import {SendMonthlyInventoryFailureEmailJob} from '../SendMonthlyInventoryFailureEmailJob';
...
describe('SendMonthlyInventoryFailureEmailJob', () => {
  beforeAll(async () => {
  ...
  it('schedules jobs for shops that have notification frequency set to monthly', async () => {
    ...
    const job = new SendMonthlyInventoryFailureEmailJob({});
